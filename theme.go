...
type fyneLightTheme struct{}

func (fyneLightTheme) Color(c fyne.ThemeColorName, v fyne.ThemeVariant) color.Color {
	switch c {
	case theme.ColorNameBackground:
		return color.NRGBA{R: 0xff, G: 0xff, B: 0xff, A: 0xff}
	case theme.ColorNameButton:
		return color.NRGBA{R: 0x1, G: 0x1, B: 0x1, A: 0x1d}
...
func (fyneLightTheme) Font(s fyne.TextStyle) fyne.Resource {
	if s.Monospace {
...
func (fyneLightTheme) Icon(n fyne.ThemeIconName) fyne.Resource {
	return theme.DefaultTheme().Icon(n)
}

func (fyneLightTheme) Size(s fyne.ThemeSizeName) float32 {
	switch s {
